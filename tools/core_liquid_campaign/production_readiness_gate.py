...
def _service_evidence_gate(repository_root: Path, *, cache_manifest_sha256: str, implementation_commit: str) -> dict[str, Any]:
    roots = {
        "current_production": repository_root / "results/rebaseline/stage24_shadow_service_canary_20260721_v10/run",
    ...
    current_spec_path = repository_root / "results/rebaseline/stage24_shadow_service_canary_20260721_v10/SHADOW_SERVICE_SPEC.json"

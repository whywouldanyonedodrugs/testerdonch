---
status: current consolidated Kraken learning state; application pending verified source replacement
date: 2026-07-19
revision: 1.0
...
supersedes: prior statements that 2023-2025 OI, basis, and liquidation analytics were unavailable
